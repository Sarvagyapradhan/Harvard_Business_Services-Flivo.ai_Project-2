...
interface InternationalFormationPackagesProps {
  onNavigate?: (destination: PageKey) => void
}

const InternationalFormationPackages: React.FC<InternationalFormationPackagesProps> = ({ onNavigate }) => {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-white">
      ...
      <main>
        {/* Section 1 - Total height: auto for responsiveness */}
        <section className="w-full min-h-screen h-auto relative flex flex-col items-center justify-start overflow-visible mt-[72px] bg-why-delaware pb-20">
          {/* Hero Content Div - Full width like section */}
          <div className="w-full min-h-[100px] lg:min-h-[320px] flex flex-col justify-start items-center pt-4 bg-[rgba(72,159,232,0.56)] z-10 relative">
            <div className="max-w-[1440px] w-full mx-auto px-6 lg:px-12 pt-4" aria-hidden="true">
              <div className="h-[0px] lg:h-[200px]" />
            </div>
          </div>

          {/* Second Content Div - Full width like section */}
          <div className="w-full flex-1 flex flex-col justify-start items-center pt-10 z-10 bg-[url('/Payments/image.png')] bg-cover bg-center bg-[rgba(19,19,19,0.7)] bg-blend-multiply -mt-[50px] lg:-mt-[220px] pb-20 relative">
            <div className="max-w-[1440px] w-full mx-auto px-6 lg:px-12 mb-12 mt-10 lg:mt-20 animate-fade-in-up">
              <h1 className="text-white text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-center leading-tight">
                Compare International Delaware LLC or <br className="hidden sm:block" />
            ...
            <div className="w-full animate-fade-in-up delay-100">
              <div className="w-full bg-white/30 backdrop-blur-[32px] px-4 sm:px-6 lg:px-10 py-8 lg:py-10 mt-0">
                <div className="max-w-[1440px] w-full mx-auto flex flex-col lg:flex-row gap-8 lg:gap-12">
                  ...
                  <div className="w-full lg:w-[450px] flex-shrink-0 animate-slide-in-left delay-200">
                    <div className="bg-white rounded-lg overflow-hidden shadow-lg">
                      {/* Header */}
                      <div className="bg-[#3ea3f2] px-6 py-5">
                        <h3 className="text-white text-xl sm:text-2xl font-bold text-left">Included in all packages</h3>
                      </div>
                      {/* List Items */}
                      <div className="divide-y divide-gray-200">
                        {includedFeatures.map((feature, index) => (
                          <div key={index} className="px-6 py-4 flex items-center gap-3 hover:bg-blue-50 transition-colors duration-300">
                            ...
                            <span className="text-[#3ea3f2] font-semibold text-base sm:text-lg lg:text-xl">{feature}</span>
                          </div>
                        ))}
                      </div>
                    </div>
            ...
            <div className="w-full mt-0 z-10 animate-fade-in-up delay-300">
              <div className="w-full bg-white/30 backdrop-blur-[32px] px-4 sm:px-6 lg:px-10 py-8 lg:py-10">
                <div className="max-w-[1440px] w-full mx-auto">
                  <h2 className="text-white text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold text-center mb-8 lg:mb-12">
                    ...
                    {packages.map((pkg, idx) => (
                      <div key={pkg.name} className="min-w-[85vw] sm:min-w-[380px] lg:min-w-0 snap-center flex flex-col relative transform hover:-translate-y-2 transition-transform duration-300 group" style={{ animationDelay: `${idx * 100}ms` }}>
                        <div className="flex-1 bg-white rounded-lg overflow-hidden shadow-xl flex flex-col h-full">
                          ...
                          {/* Includes Section */}
                          <div className="px-5 py-3 bg-[#4a90e2] text-white min-h-[90px] h-auto flex flex-col justify-center">
                          ...
                          <button className="w-full bg-[#4a90e2] text-white font-bold py-4 hover:bg-blue-500 transition-colors text-center uppercase tracking-wide text-sm group-hover:bg-blue-600">
                            LEARN MORE
                          </button>
                        </div>
                        ...
                        <div className="flex justify-center mt-4">
                          <button className="bg-[#4a90e2] text-white font-bold py-3 px-8 rounded-[4px] hover:bg-blue-500 transition-colors flex items-center gap-2 shadow-md text-sm uppercase tracking-wide transform hover:scale-105 duration-200">
                            <span>Order Now</span>
                            <svg
                              width="16"
                              height="16"
          ...
          <div className="w-full min-h-[600px] h-auto flex flex-col items-center pt-14 pb-16 z-10 bg-[url('/Payments/image2.png')] bg-cover bg-center bg-[rgba(0,0,0,0.6)] bg-blend-multiply">
            <div className="w-full max-w-[1440px] px-6 lg:px-12">
              <h2 className="text-white text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-center mb-12 animate-fade-in-up">
                Available Add-Ons
              </h2>
            </div>

            <div className="w-full bg-white/30 backdrop-blur-[32px] py-10 lg:py-12 animate-fade-in-up delay-200">
              <div className="max-w-[1440px] mx-auto px-6 lg:px-12 flex flex-col gap-8">
                {addOns.map((addon, index) => (
                  <div key={index} className="flex flex-col md:flex-row bg-white rounded-lg overflow-hidden shadow-lg min-h-[160px] hover:shadow-xl transition-shadow duration-300">
                    {/* Left Content */}
                    <div className="flex-1 p-6 md:p-10 flex flex-col justify-center">
                      <h3 className="text-[#3ea3f2] text-xl sm:text-2xl lg:text-3xl font-bold mb-4 uppercase">{addon.title}</h3>
                      <p className="text-[#4a90e2] text-base sm:text-lg lg:text-xl leading-relaxed">{addon.description}</p>
                    </div>

                    {/* Right Price */}
                    <div className="w-full md:w-[220px] bg-white border-t md:border-t-0 md:border-l border-gray-100 p-8 flex flex-col justify-center items-center bg-gray-50">
                      <span className="text-[#3ea3f2] text-base font-bold mb-2">Starting at</span>
                      <div className="text-[#3ea3f2] text-5xl lg:text-6xl font-bold flex items-start">
                        <span className="text-2xl lg:text-3xl mt-2 mr-1">$</span>
                        {addon.price}
                      </div>
                    </div>
                  </div>
                ...
                <div className="flex justify-center mt-8">
                  <button className="bg-[#4a90e2] text-white font-bold py-4 px-10 rounded-[4px] hover:bg-blue-500 transition-all duration-300 flex items-center gap-2 shadow-lg text-lg transform hover:scale-105">
        ...
        <section className="relative w-full min-h-[600px] lg:h-[812px] bg-white overflow-hidden flex flex-col lg:flex-row justify-center py-20 lg:py-0">
          ...
          <div className="absolute inset-0 bg-gray-100 lg:hidden"></div>

          <div className="absolute top-[156px] left-0 right-0 h-[529px] bg-[#69a6db] hidden lg:block"></div>
          ...
          <div className="relative lg:absolute lg:left-1/2 lg:-translate-x-1/2 lg:top-[90px] w-full max-w-[1325px] lg:h-[335px] z-10">
            ...
            {[
              ...
              <div
                ...
                className="min-w-[85vw] sm:min-w-[380px] lg:min-w-0 snap-center flex-1 bg-white rounded-2xl flex flex-col gap-4 p-6 h-auto lg:h-full shadow-[0px_18px_36px_rgba(15,23,42,0.2)] transform hover:-translate-y-2 transition-transform duration-300"
              >
          ...
          <div className="relative lg:absolute lg:left-1/2 lg:-translate-x-1/2 lg:top-[450px] flex flex-col items-center gap-6 w-full px-6 mt-8 lg:mt-0 z-10">
            <p className="text-[#333] lg:text-white text-2xl sm:text-3xl lg:text-4xl font-semibold text-center">
              Our goal is to make business easy.
            </p>
            <div className="flex flex-col items-center gap-3">
              <span className="text-[#333] lg:text-white text-4xl sm:text-5xl lg:text-6xl font-bold">25,316 reviews</span>
              <div className="flex flex-col sm:flex-row items-center gap-4 mt-4 sm:mt-0">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-[#333] lg:text-white text-3xl font-semibold">4.8</span>
                </div>
              </div>
            </div>
          </div>
          
          <div className="w-full max-w-[1440px] h-full flex flex-col hidden lg:flex">
...
export default InternationalFormationPackages
