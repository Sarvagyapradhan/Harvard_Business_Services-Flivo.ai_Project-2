...
const Services: React.FC<ServicesProps> = ({ onNavigate }) => {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-white">
      ...
      <main>
        <section 
          className="w-full min-h-screen h-auto relative flex flex-col items-start justify-start overflow-hidden mt-[72px] bg-why-delaware pb-20"
        >
          {/* Hero Content Div - Height: auto on mobile, fixed on desktop */}
          <div className="relative w-full flex flex-col justify-start items-center pt-8 pb-8 bg-[rgba(72,159,232,0.56)] z-10">
            {/* Content Container */}
          ...
          {/* Second Content Div */}
          <div className="relative w-full flex flex-col justify-start items-center pt-8 pb-8 bg-why-delaware-second z-10">
            <div className="max-w-[1440px] w-full mx-auto px-6 lg:px-12">
          ...
          {/* Third Content Div */}
          <div className="relative w-full flex flex-col justify-start items-center pt-8 pb-8 bg-why-delaware-image1 z-10">
            <div className="max-w-[1440px] w-full mx-auto px-6 lg:px-12">
              <h2 className="text-white text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-center mb-8 mt-0">
          ...
          <div className="relative w-full min-h-screen flex flex-col items-center pt-14 pb-16 bg-additional-services z-10">
