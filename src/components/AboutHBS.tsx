                    ...
                    <div className="w-full max-w-[980px] flex flex-col gap-10 text-white">
                      ...
                      <div className="mt-6 flex justify-end">
                        <div className="w-full max-w-[380px]">
                          <div className="relative w-full rounded-[10px] shadow-[0px_22px_45px_rgba(0,0,0,0.55)] border border-white/20 bg-black/20 overflow-visible">
                            ...
                            <div className="absolute -top-2 left-0 -translate-x-[80%] w-[86%]">
                              <div className="rounded-[10px] bg-[#00B67A] px-5 py-3 shadow-[0px_16px_30px_rgba(0,0,0,0.7)] flex items-center justify-between text-white text-[18px] sm:text-[20px]">
                                <div className="flex flex-col">
                                  <span className="font-bold text-[22px] sm:text-[24px]">25,316 reviews</span>
                                  <span className="text-[14px] sm:text-[15px] flex items-center gap-2">
                                    <span className="inline-flex items-center bg-white text-[#00B67A] px-2 py-0.5 rounded-[4px] text-[13px] font-semibold leading-none">
                                      <svg
                                        width="14"
                                        height="14"
                                        viewBox="0 0 24 24"
                                ...
                                <div className="flex items-center gap-2">
                                  ...
                                  <span className="font-semibold text-[19px] sm:text-[21px]">4.8</span>
                                </div>
                              </div>
                            </div>
                          </div>
