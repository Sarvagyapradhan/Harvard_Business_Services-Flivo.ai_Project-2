...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="w-full text-white py-10 lg:py-12 relative overflow-hidden">
      <div
        className="absolute inset-0 bg-footer-image"
      ></div>
      ...
      <div className="relative max-w-[1440px] mx-auto px-6 lg:px-12">
        <div className="flex flex-col gap-4">
          {/* Disclaimer */}
          <p className="text-white text-xs lg:text-sm leading-relaxed opacity-90">
          ...
          {/* Copyright */}
          <p className="text-white text-xs lg:text-sm text-center opacity-75">
