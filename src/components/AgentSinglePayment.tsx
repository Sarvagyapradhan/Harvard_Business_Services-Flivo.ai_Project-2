                ...
                <div className="max-w-6xl mx-auto rounded-[30px] border border-white/30 bg-white/95 text-slate-900 shadow-[0_25px_90px_rgba(7,33,64,0.35)] overflow-hidden">
                  ...
                  <div className="px-6 sm:px-10 py-10">
                    <form className="border border-slate-200 rounded-2xl divide-y divide-slate-200">
                      <div className="flex flex-col gap-4 px-5 py-6 sm:flex-row sm:items-start">
                        <label className="w-full text-base font-semibold text-slate-700 sm:w-48 pt-2">Company Name:</label>
                      ...
                      <div className="flex flex-col gap-4 px-5 py-6 sm:flex-row sm:items-start">
                        <label className="w-full text-base font-semibold text-slate-700 sm:w-48 pt-2">State File Number:</label>
                        <div className="flex flex-1 flex-col gap-2">
                          <input
                            type="text"
                            placeholder="Enter Your Email Address"
